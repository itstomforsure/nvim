...
local function custom_keybindings()
  ...
  remap({"n", "t"}, "<leader>e", function()
	...
	remap('n', '<leader>fg', '<cmd>Telescope live_grep<cr>', { noremap = true, silent = true, desc = "Live grep (search in files)" })
	...
	remap('n', '<leader>fl', '<cmd>Telescope lsp_references<cr>', { noremap = true, silent = true, desc = "Find lsp references" })
	remap('n', '<leader>fk', '<cmd>Telescope git_branches<cr>', { noremap = true, silent = true, desc = "Find git branches" })
end
	...
	require("lazy").setup({
      ...
      init = function()
		...
		},
		{
          ...
          indent = { enable = true },
					ensure_installed = { "vim", "vimdoc", "lua", "go", "typescript", "html", "css", "javascript", "angular" },
				})
			end,
		},
		{
